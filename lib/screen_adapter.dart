...
extension SizeExtension on num {
  num get w => ScreenAdapter().setWidth(this);

  num get h => ScreenAdapter().setHeight(this);

  num get sp => ScreenAdapter().setSp(this);

  num get ssp => ScreenAdapter().setSp(this, allowFontScalingSelf: true);
}
...
class ScreenAdapter {
  ...
  static void formMediaQueryData(MediaQueryData mediaQuery,
